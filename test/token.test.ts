...
describe('Token', () => {
  ...
  describe('#equals', () => {
    ...
    it('false if chain id differs', () => {
      expect(new Token(ChainId.ALFAJORES, ADDRESS_ONE, 18).equals(new Token(ChainId.MAINNET, ADDRESS_ONE, 18))).toBe(
        false
      )
    })
    ...
    it('true even if name/symbol/decimals differ', () => {
      const tokenA = new Token(ChainId.MAINNET, ADDRESS_ONE, 9, 'ONE', 'Token 1')
      const tokenB = new Token(ChainId.MAINNET, ADDRESS_ONE, 18, 'TWO', 'Token 2')
